...
# Claude Code skills
mkdir -p "$SKILL_DIR/test-web" "$SKILL_DIR/test-desktop" "$SKILL_DIR/test-tauri" "$SKILL_DIR/test-gate" "$SKILL_DIR/test-review"
...
echo "  Skills:  /test-gate (router), /test-web, /test-desktop, /test-tauri (alias), /test-review"
